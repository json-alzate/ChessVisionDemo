...
export class HomePage {
  ...
  pieces: Piece[] = [
    ...
    },
    {
      ...
      description: 'Es la pieza más numerosa y aparentemente más débil, pero tiene un rol estratégico crucial. Avanza una casilla (o dos en su primer movimiento) y captura en diagonal. Si llega al final del tablero, puede transformarse en cualquier pieza (excepto el rey), lo que le da un gran potencial.'
    }
  ];
